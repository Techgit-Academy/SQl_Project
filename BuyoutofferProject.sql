...
SELECT *,
	...
	WHEN Sept_paidperiod >= expectedsept_paideriod AND sept_mtnairtime_payment <= 0 THEN 'eligible'
	
	WHEN Sept_paidperiod >= expectedsept_paideriod AND sept_mtnairtime_payment > 0 AND sept_mtn_paidperiod  <  Sept_paidperiod THEN 'mixed_payment'
	
	WHEN Sept_paidperiod >= expectedsept_paideriod AND sept_mtnairtime_payment> 0 AND sept_mtnairtimebank_payment  <= 0 AND sept_quickteller_payment <= 0 AND   sept_corapay_payment <= 0  AND  sept_directbank_payment <= 0 THEN 'fullairtimepayment'
